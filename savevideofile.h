...
public:
    ...
    int getAudioListSize(){return mAudioDataList.size();}
...
signals:
    ...
    void SIG_closeVideoThread();

protected:
    void run();

public:
    QList<BufferDataNode*> mVideoDataList;
    QList<BufferDataNode*> mAudioDataList;
    int write_frame(AVFormatContext *fmt_ctx, OutputStream *ost, int64_t &pts);
